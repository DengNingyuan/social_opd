...
- `confidence`: overall reliability of the measurement.
...
- `direct_teacher`: teacher produces score/confidence directly without evidence.
- `evidence_teacher`: teacher produces evidence then score/confidence.
